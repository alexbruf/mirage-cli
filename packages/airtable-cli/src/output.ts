...
/**
 * Airtable records nest their cell values under `fields` — lift those up one
 * level for table/csv so `Name` lands as a column instead of a blob, while
 * keeping `id`/`createdTime` alongside.
 */
