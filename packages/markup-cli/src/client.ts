...
export const TOOL = {
  listBoards: "marklayer_list_boards",
  createBoard: "marklayer_create_board",
  roomInfo: "marklayer_room_info",
  readPage: "marklayer_read_page",
  list: "marklayer_list_annotations",
  get: "marklayer_get_annotation",
  watch: "marklayer_watch_annotations",
  acknowledge: "marklayer_acknowledge",
  resolve: "marklayer_resolve",
  dismiss: "marklayer_dismiss",
  reply: "marklayer_reply",
  create: "marklayer_create_annotation",
  suggest: "marklayer_suggest_edit",
} as const;
