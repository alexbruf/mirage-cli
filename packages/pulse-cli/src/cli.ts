...
/**
 * Build the Pulse Commander program. Pure function — no side effects, safe
 * to call from in-process wrappers (`@mirage-cli/pulse`) or the CLI entry
 * point below.
 */
export function buildProgram(): Command {
  ...
  program
    .name("pulse")
    .description("ViewEngine Pulse CLI — batch AI visibility jobs")
    .version("0.1.0");
